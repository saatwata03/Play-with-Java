...
public class RhythmShooter extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        gameOverText.setFont(new Font(60)); // Larger font size
        ...
        scene.setOnKeyPressed(event -> {
            ...
            if (event.getCode() == KeyCode.LEFT) {
                ...
                Bullet bullet = new Bullet(player.x + 22.5, player.y); // Center of player
                bullets.add(bullet);
    ...
    private void updatePlayerPosition(double deltaSeconds) {
        double moveDistance = PLAYER_SPEED * deltaSeconds;
